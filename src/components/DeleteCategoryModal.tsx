    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <Card variant="glass" className="w-full max-w-md">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-foreground">Delete Category</h2>
          <button
            onClick={onClose}
            disabled={loading}
          ...
          <div className="bg-danger/10 border border-danger/30 rounded-lg p-4">
            ...
            {transactionCount > 0 ? (
              <p className="text-sm text-muted">
                This category is used in <strong>{transactionCount}</strong> transactions. 
                You must reassign them to another category before deleting.
              </p>
            ) : (
              <p className="text-sm text-muted">
                This category is not used in any transactions. It will be permanently deleted.
              </p>
            )}
          </div>
