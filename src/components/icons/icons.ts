export const icons = {
  // Categories (Piggy Bank Themed - Simplified to clean line art for reliability)
  ...
  dining: "M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2M7 2v20M21 15V2v0a5 5 0 00-5 5v6c0 1.1.9 2 2 2h3zm0 0v7",
  transport: "M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5", // Car-ish abstract
  transport_alt: "M5 17a2 2 0 104 0H5zm10 0a2 2 0 104 0h-4zm-9-2h10v-2a4 4 0 00-4-4H9a4 4 0 00-4 4v2zm-4 0h2m14 0h2m-6-9l2-2m-8 2l-2-2", // Better car
  utilities: "M13 10V3L4 14h7v7l9-11h-7z", // Lightning bolt
  entertainment: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z", // Video camera
  shopping: "M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z", // Shopping bag
  ...
  reports_alt: "M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z", // Pie chart part 2 (combined usually, but let's use a simple pie)
  pie_chart: "M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z", // Full pie
  ...
  // Person/Users
  personal: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z", // User
  joint: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z", // Users group
  ...
  // Piggy Bank (Special)
  piggy_bank: "M19 14c0 2.21-3.58 4-8 4s-8-1.79-8-4 3.58-4 8-4 8 1.79 8 4z M7 17v3 M15 17v3 M5 12l-2-2 M17 12l2-2 M4 14a1 1 0 100 2 1 1 0 000-2 M11 8h2 M12 5v2",
  savings: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z", // Coin (reused income)
  ...
  vacation: "M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z", // Sun (reused)
  emergency: "M13 10V3L4 14h7v7l9-11h-7z", // Lightning (reused utilities)
  education: "M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222",
...
// Let's use a "Piggy Bank" path from a standard set if possible or construct one.
// Constructing a simple one: Body oval, nose, ears, legs, coin slot.
// Body: M19 14c0 2.21-3.58 4-8 4s-8-1.79-8-4 3.58-4 8-4 8 1.79 8 4z
// Legs: M7 17v3 M15 17v3
// Ears: M5 12l-2-2 M17 12l2-2
// Snout: M4 14a1 1 0 100 2 1 1 0 000-2
// Slot: M11 8h2
// Coin: M12 5v2
icons.piggy_bank = "M19 14c0 2.21-3.58 4-8 4s-8-1.79-8-4 3.58-4 8-4 8 1.79 8 4z M7 17v3 M15 17v3 M5 12l-2-2 M17 12l2-2 M4 14a1 1 0 100 2 1 1 0 000-2 M11 8h2 M12 5v2"
