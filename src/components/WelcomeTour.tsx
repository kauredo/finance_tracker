  ...
  const steps = [
    {
      ...
      description:
        "Your new financial home. Track expenses, manage budgets, and achieve your goals.",
      icon: "home" as const,
      color: "text-primary",
    },
    {
      ...
      description:
        "Log transactions easily. Categorize them to see exactly where your money goes.",
    ...
    },
    {
      title: "Stay on Top",
      description:
        "Set budgets and get insights with beautiful reports. You're in control.",
      icon: "chart" as const,
    ...
    >
      ...
      >
        ...
        <div className="p-8 text-center">
          <div
            className={`w-24 h-24 mx-auto mb-6 rounded-full bg-surface-alt flex items-center justify-center ${currentStepData.color}`}
          >
