...
const Card = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const baseStyles =
      variant === "glass"
        ? "bg-surface/80 backdrop-blur-lg rounded-2xl p-6 border border-border/50 transition-all shadow-2xl"
        : "bg-surface rounded-2xl p-6 border border-border transition-all";

    const variantStyles = {
      default: "shadow-sm",
      interactive:
        "shadow-sm hover:border-primary/30 hover:shadow-md hover:-translate-y-1 cursor-pointer duration-300",
