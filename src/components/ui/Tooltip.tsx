  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          role="tooltip"
          className={`absolute z-50 px-3 py-2 text-sm text-white bg-gray-900 rounded-lg shadow-lg whitespace-nowrap animate-in fade-in duration-150 ${positionClasses[position]}`}
        >
          {content}
          <div
