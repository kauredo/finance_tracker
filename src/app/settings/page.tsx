          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                <Link href="/accounts" className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white">Accounts</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Manage bank accounts</p>
                  </div>
                  <Icon name="chevron_down" className="w-5 h-5 text-gray-400 ml-auto -rotate-90" />
                </Link>

                <Link href="/categories" className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Customize categories</p>
                  </div>
                  <Icon name="chevron_down" className="w-5 h-5 text-gray-400 ml-auto -rotate-90" />
                </Link>
            ...
            <div className="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                <Link href="/export" className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Download your history</p>
                  </div>
                  <Icon name="chevron_down" className="w-5 h-5 text-gray-400 ml-auto -rotate-90" />
                </Link>
              </div>
